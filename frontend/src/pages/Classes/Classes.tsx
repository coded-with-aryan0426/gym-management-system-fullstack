    ...
    <div className="classes-page">
      <ScheduleHeader
        ...
        inlineStats={[
          { 
            label: 'Today', 
            value: enhancedStats.todayTotal, 
            icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>,
            color: 'emerald',
            live: enhancedStats.inProgressNow > 0 ? enhancedStats.inProgressNow : undefined
          },
          { 
            label: 'This Week', 
          ...
          { 
            label: 'Occupancy', 
            value: `${enhancedStats.occupancyRate}%`, 
            ...
            color: 'violet',
            progress: enhancedStats.occupancyRate
          },
          { 
            label: 'Spots Left', 
            value: enhancedStats.availableSpots, 
