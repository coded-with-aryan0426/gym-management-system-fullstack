      ...
      if (searchQuery.length > 1) {
        try {
          ...
          const mockResults: SearchResult[] = [
            { id: '1', type: 'member', title: 'John Smith', subtitle: 'Gold Plan • Active', link: '/members' },
            { id: '2', type: 'member', title: 'Sarah Williams', subtitle: 'Silver Plan • Active', link: '/members' },
            { id: '3', type: 'staff', title: 'Mike Johnson', subtitle: 'Personal Trainer', link: '/staff' },
            { id: '4', type: 'session', title: 'PT Session #124', subtitle: 'Tomorrow at 10:00 AM', link: '/pt-sessions' },
          ].filter(r =>
