...
\usepackage{xcolor}
\usepackage[a4paper,left=1.5in,right=1.0in,top=1.0in,bottom=1.0in,headheight=0.5in,headsep=0.2in,footskip=0.4in]{geometry}
...
\providecommand{\tightlist}{%
  \setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\setlength{\topsep}{2pt}\setlength{\partopsep}{0pt}}
%% =============================================================================
...
%% ---- Paragraph (tighter for space efficiency) ----
\setlength{\parindent}{0pt}
\setlength{\parskip}{3pt plus 1pt minus 1pt}

%% ---- LongTable pre/post spacing (minimal) ----
\setlength{\LTpre}{2pt}
...
%% ---- Chapter Heading (12pt as required, tighter spacing) ----
\titleformat{\chapter}[hang]
  {\normalfont\fontsize{12}{18}\selectfont\bfseries\color{reportprimary}}{\chaptername\ \thechapter:}{6pt}{\fontsize{12}{18}\selectfont\bfseries\color{reportprimary}}
\titlespacing*{\chapter}{0pt}{-30pt}{8pt}

\newcommand{\sectionbreak}{\needspace{2\baselineskip}}
\titleformat{\section}{\normalfont\fontsize{12}{18}\selectfont\bfseries\color{reportprimary}}{\thesection}{1em}{}
\titlespacing*{\section}{0pt}{8pt plus 2pt}{3pt plus 1pt}
\titleformat{\subsection}{\normalfont\fontsize{12}{18}\selectfont\bfseries\color{reportprimary}}{\thesubsection}{1em}{}
\titlespacing*{\subsection}{0pt}{6pt plus 2pt}{2pt plus 1pt}
\titleformat{\subsubsection}{\normalfont\fontsize{12}{18}\selectfont\bfseries\color{reportprimary}}{\thesubsubsection}{1em}{}
\titlespacing*{\subsubsection}{0pt}{5pt plus 1pt}{1pt}

%% ---- Captions (Chapter-Number style: Figure 2-3) ----
\captionsetup[table]{labelsep=endash, font={size=12}, justification=centering, position=below}
\captionsetup[figure]{labelsep=endash, font={size=12}, justification=centering, position=below}
...
% Background image removed as per requirements
...
Bharti Soft Tech Pvt. Ltd. is a software development company based in India, specialising in custom technology solutions for businesses across healthcare, fitness, education, and e-commerce sectors. The organisation focuses on building accessible, scalable platforms addressing operational challenges for SMEs.

The internship involved contributing to end-to-end design and development of a Smart Gym Management System within the Software Development Department. The team operated under agile methodology with sprint cycles, daily stand-ups, and stakeholder reviews. Under supervision of Dr. Ashutosh Abhangi, the intern gained exposure to professional development practices and architectural decision-making.
...
Primary objectives of Bharti Soft Tech Pvt. Ltd.:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Deliver robust, scalable custom software solutions across multiple industries.
\item
  Reduce cost and complexity of enterprise software adoption for SMEs.
\item
  Adhere to best practices in security, performance, and software architecture.
\item
  Provide mentorship and real-world project exposure to interns and junior developers.
\item
  Adopt modern technology stacks aligned with industry trends.
\end{enumerate}

These objectives shaped the technical and functional requirements of the Smart Gym Management System.
...
The project commenced with requirements-gathering and feasibility analysis (Weeks 1--4). Under guidance of Dr. Ashutosh Abhangi, structured literature search examined existing platforms including Mindbody, Zen Planner, PushPress, GymMaster, and Wodify to identify functional gaps.
...
This gap analysis shaped the AthlonX vision: an open-source, self-hosted alternative matching commercial competitors [14].

\subsection{Technology Stack Selection and
Rationale}\label{technology-stack-rationale}

Following structured evaluation, key technologies were selected:

\textbf{Frontend --- React 18 with TypeScript:} Component-based architecture enables reusable UI components; Virtual DOM optimises rendering for data-intensive dashboards [1]. TypeScript adds static type safety, reducing runtime errors [3]. Selected over Vue.js and Angular for maturity and ecosystem richness.

\textbf{Backend --- Spring Boot 3 with Java 17:} Auto-configuration enabled rapid REST API setup. Spring Security 6 provided authentication/authorisation framework.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_system_architecture_0.png}
\caption*{Figure~4-1: High-Level System Architecture}
\end{figure}

\smallskip\noindent
Three-tier architecture: React frontend communicates with Spring Boot backend via RESTful APIs and WebSocket, while backend persists data in Oracle database. External services (OAuth, SMTP, Twilio) integrate at backend layer.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_system_architecture_1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_system_architecture_2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_er_diagram_0.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_er_diagram_1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_er_diagram_2.png}
...
The Data Dictionary provides technical specifications for the database schema, designed to maintain relational integrity while supporting multi-role SaaS operations.

% --- USERS TABLE ---
\subsubsection{Table: USERS}
Primary repository for system actors managing authentication and profile data.

{\def\LTcaptype{none}
\begin{longtable}[]{@{}lllc p{5.5cm}@{}}
\hline
...
Defines functional authorization boundaries for role-based access control.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_uml_diagrams_0.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_uml_diagrams_4.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_uml_diagrams_5.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_uml_diagrams_6.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_dfd_diagrams_0.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_dfd_diagrams_1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_system_architecture_4.png}
...
The AthlonX architecture ensures high availability and seamless growth through multiple infrastructure layers:

\begin{enumerate}
    \item \textbf{Isolated Multi-Tenancy}: Each gym functions as a logically isolated environment using unique \texttt{gym\_id} discriminators, ensuring data sovereignty and supporting thousands of tenants without compromising security.
    
    \item \textbf{Stateless Horizontal Scaling}: JWT authentication eliminates server-side session storage, enabling new backend instances to be deployed behind a load balancer as traffic increases.
    
    \item \textbf{Distributed Caching}: Spring's caching abstraction stores frequently accessed data (pricing tiers, gym metadata) in memory, reducing database load and ensuring instantaneous dashboard rendering.
    
    \item \textbf{Efficient Resource Management}: HikariCP connection pool maintains warm database connections, avoiding latency penalties and preventing connection exhaustion during peak hours.
    
    \item \textbf{Asynchronous Real-Time Messaging}: STOMP broker channels over WebSockets handle thousands of simultaneous connections, delivering messages with sub-50ms latency.
    
    \item \textbf{Performance-Tuned Lazy Loading}: JPA's lazy-fetch strategy retrieves large object graphs only when accessed, minimizing memory footprint.
\end{enumerate}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_workflows_0.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_workflows_1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_workflows_4.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_workflows_2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_workflows_3.png}
\caption*{Figure~5-5: Membership Expiry Handling}
\end{figure}

\smallskip\noindent
The membership lifecycle transitions from \texttt{PENDING} to \texttt{ACTIVE}, \texttt{EXPIRED}, or \texttt{CANCELLED} through state-machine architecture. A Spring \texttt{@Scheduled} cron job (\texttt{0 0 0 * * *}) performs daily audits at midnight, identifying subscriptions with \texttt{end\_date} less than current timestamp. 

\subsection{Algorithm 3: Membership Assignment}\label{algo-membership}

\noindent\textbf{Purpose:} Robust mechanism for managing membership state transitions, credit allocations, and subscription extensions.

\smallskip
\noindent\textbf{How it works:}
\begin{enumerate}
    \item \textbf{Package Selection:} Member selects package DTO containing duration and PT session count.
    \item \textbf{Overlap Check:} System queries database for existing \texttt{ACTIVE} membership.
    \item \textbf{Credit-Adjusted Extension:} If active subscription exists, remaining days are credited proportionally and new duration appended. Otherwise, status set to \texttt{PENDING}.
    \item \textbf{Session Credit Allocation:} PT session credits incremented in member's ledger.
    \item \textbf{Expiry Calculation:} System sets \texttt{end\_date} timestamp accounting for leap years and time zones.
    \item \textbf{State Confirmation:} Upon approval or payment success, status updated to \texttt{ACTIVE}.
\end{enumerate}
...
\noindent
Personal training sessions are booked using credit units allocated at membership purchase.

\subsection{PT Session Booking Flow}\label{wf-session}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_workflows_6.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_workflows_8.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,height=0.65\textheight,keepaspectratio]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/mermaid_workflows_11.png}
...
% ── SIGNUP SCREEN ──
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=4pt,line width=0.4pt] (signup_box) at (0,0) {\includegraphics[width=0.31\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/Singup.png}};
\end{tikzpicture} &
% ── LOGIN SCREEN ──
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=4pt,line width=0.4pt] (login_box) at (0,0) {\includegraphics[width=0.31\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/Login.png}};
\end{tikzpicture} &
% ── OTP SCREEN ──
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=4pt,line width=0.4pt] (otp_box) at (0,0) {\includegraphics[width=0.31\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/OTP.png}};
\end{tikzpicture} \\
\vspace{0.1cm} \\
...
\centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=6pt,line width=0.4pt] (dashboard_box) at (0,0) {\includegraphics[width=\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/Dashbord.png}};
\end{tikzpicture}
...
\centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=6pt,line width=0.4pt] (members_box) at (0,0) {\includegraphics[width=\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/Memebrs list.png}};
\end{tikzpicture}
...
\centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=6pt,line width=0.4pt] (trainers_box) at (0,0) {\includegraphics[width=\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/Trainers list.png}};
\end{tikzpicture}
...
\centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=6pt,line width=0.4pt] (equipment_box) at (0,0) {\includegraphics[width=\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/ Equipment page.png}};
\end{tikzpicture}
...
\centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=6pt,line width=0.4pt] (financial_box) at (0,0) {\includegraphics[width=\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/Financial.png}};
\end{tikzpicture}
...
\centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=6pt,line width=0.4pt] (todo_box) at (0,0) {\includegraphics[width=\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/Todo.png}};
\end{tikzpicture}
...
\centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=6pt,line width=0.4pt] (profile_box) at (0,0) {\includegraphics[width=0.45\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/Profile pop window.png}};
\end{tikzpicture}
...
\centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=6pt,line width=0.4pt] (settings_box) at (0,0) {\includegraphics[width=\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/setting page.png}};
\end{tikzpicture}
...
\centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0,draw=black!30,rounded corners=6pt,line width=0.4pt] (notif_box) at (0,0) {\includegraphics[width=\textwidth]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Application_Screenshot/Notification.png}};
\end{tikzpicture}
...
\noindent
The lessons this experience leaves behind are durable. Technical decisions made in isolation rarely stay isolated. A schema change ripples into APIs, which ripple into UI components, which ripple into user experience. Understanding \textit{systems thinking} --- seeing the whole, not just individual parts --- is what separates a software developer from a software engineer.

\vspace{0.15cm}

\noindent
To the reader evaluating this report: what is presented here is not the end of a project, but the \textbf{beginning of a platform}. The roadmap ahead --- mobile apps, payment gateways, AI-powered training plans, and microservices --- exists because the foundation was built to support it. This is software designed to evolve.
...
% Offset moves content: positive X = right, negative X = left
% Main report has left=1.5in, right=1.0in (0.5in difference)
% So we shift research paper right by 12mm to match asymmetric layout
\includepdf[
  pages=1,
...
% Embed the remaining pages with same right offset.
\includepdf[
  pages=2-,
