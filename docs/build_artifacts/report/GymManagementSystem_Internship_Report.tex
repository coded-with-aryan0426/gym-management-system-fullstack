...
\subsection{E.5 Research Paper}

\clearpage

% Embed research paper pages with report header/footer overlaid
\includepdf[
  pages=-,
  pagecommand={\thispagestyle{fancy}},
  fitpaper=false,
  width=\textwidth
]{/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/research_and_theory/research_paper.pdf}
