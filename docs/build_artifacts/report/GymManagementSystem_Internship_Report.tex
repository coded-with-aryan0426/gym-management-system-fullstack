...
% ── Logo ────────────────────────────────────────────────────────────────────
\begin{flushright}
  \includegraphics[width=2.5cm]{styles/university_logo.png}
\end{flushright}

\vspace{0.2cm}

% ── Title ───────────────────────────────────────────────────────────────────
{\large\textbf{INTERN ASSESSMENT FORM}}

\vspace{0.4cm}

% ── Info table ──────────────────────────────────────────────────────────────
\renewcommand{\arraystretch}{1.35}
\begin{tabular}{@{}p{5.0cm} @{} p{0.3cm} @{} p{8.5cm}@{}}
Enrolment Number                & : & \underline{\hspace{8.2cm}} \\
Full Name of Intern             & : & \underline{\hspace{8.2cm}} \\
Name of Organization            & : & \underline{\hspace{8.2cm}} \\
External Supervisor             & : & \underline{\hspace{8.2cm}} \\
Date                            & : & \underline{\hspace{8.2cm}} \\
Intern's Position or Assignment & : & \underline{\hspace{8.2cm}} \\
Project Title                   & : & \underline{\hspace{8.2cm}} \\
\end{tabular}
...
\newcommand{\scoredrow}[1]{%
  \noindent\begin{tabular}{|p{5.8cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{0.9cm}|>{\centering\arraybackslash}p{0.9cm}|}
  \hline
  #1 & 1 & 2 & 3 & 4 & 5 \\
  \hline
...
{\sffamily
\begin{center}
  \textbf{\Large FINAL YEAR INTERNSHIP WEEKLY REPORT}
\end{center}
