...
\begin{center}
    \vspace*{\fill}
    \includegraphics[width=\textwidth,scale=0.95]{"/Volumes/Aryan/Aryan/Sem 8/Intership/gym-management-system-fullstack/docs/build_artifacts/report/Internship Certificate -Aryan Suthar.jpg"}
    \vspace*{\fill}
\end{center}
\clearpage
\vspace*{1cm}
